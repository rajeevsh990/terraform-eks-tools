...
# Kubectl for AWS EKS
ADD https://amazon-eks.s3.us-west-2.amazonaws.com/1.16.15/2020-11-02/bin/linux/amd64/kubectl /usr/local/bin/kubectl
RUN chmod +x /usr/local/bin/kubectl

# AWS IAM Authenticator.
ADD https://amazon-eks.s3.us-west-2.amazonaws.com/1.16.15/2020-11-02/bin/linux/amd64/aws-iam-authenticator /usr/local/bin/aws-iam-authenticator
